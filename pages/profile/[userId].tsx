...
const Profile = ({ data }: IProps) => {
  ...
  return (
    <div className="w-full">
      <Head>
        <title>TikTik - {user.userName}</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/tiktik-icon.png" />
      </Head>

      <div className="flex gap-6 md:gap-10 mb-4 bg-white dark:bg-[#0f1217] w-full">
      ...
      <div>
        <div className="flex gap-10 mb-10 mt-10 border-b-2 border-gray-200 bg-white dark:bg-[#0f1217] w-full">
          <p
