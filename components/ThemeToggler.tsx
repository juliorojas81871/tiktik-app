...
const ThemeToggler = () => {
  ...
  return (
    ...
    >
      ...
      />
      <div className="w-14 h-7 bg-gray-200 peer-focus:outline-none peer-focus:ring peer-focus:ring-[#F51997] dark:peer-focus:ring-[#F51997] rounded-full peer dark:bg-[#3B3B3B] dark:border-gray-600 peer-checked:bg-gray-600"></div>
